...
public class QueryPathFilter implements ContainerRequestFilter {
	...
	public ContainerRequest filter(ContainerRequest arg0) {
		...
		String[] legalPath = {"pais/list/paisuids", "pais/list/imageuids", "pais/list/slideuids", "pais/list/patientuids", 
				...
				"validation/segmentation", "validation/classification", "validation/image", "validation/mask", "validation/overlay"
		};
...
public class QueryPathFilter implements ContainerRequestFilter {
	...
	public ContainerRequest filter(ContainerRequest arg0) {
		...
		String[] legalPath = {"pais/list/paisuids", "pais/list/imageuids", "pais/list/slideuids", "pais/list/patientuids", 
				...
				"images/image/tiling/positions", "images/image/dimension","images/thumbnail/tiledimage","images/image/imagereferences","pais/list/summary","patient/features","pais/list/tile/regions",
				"pais/markups/humanannotation/annotation/add","pais/markups/humanannotation/annotation/get","pais/markups/boundaries/image",
				"validation/segmentation", "validation/classification", "validation/image", "validation/maskimage", "validation/usermaskimage", "validation/mask", "validation/overlay", "validation/segmentationbyimage"
		};

...
public class CachingManager {
	...
	public PreparedStatement getPreparedStatement (String queryName){
		if(pstmtMap.containsKey(queryName)){
			...
			PreparedStatement pstmt = pstmtMap.get(queryName);
			//pstmtMap.remove(queryName);
			return pstmt;
		}	
		return null;
	}
	...
	public PreparedStatement setPreparedStatementAndParams(String queryName, String sql, Properties props){
		...
		try
		{
			...
			if(WebAPI.db==null||WebAPI.db.getDBConnection()==null||WebAPI.db.getDBConnection().isClosed())
			{	
			WebAPI.db.close();
		...
		*/
		PreparedStatement pstmt = this.db.getPareparedStatement(sql);
